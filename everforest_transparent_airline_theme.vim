...
" Colors
let s:gray     = [245, '#a7c080'] " normal font
let s:darkgray = [245, '#1d1f21'] " text inside way right
let s:golden   = [143, '#a7c080'] " INSERT Color - way left
let s:pink     = [131, '#e69875'] " Visual block
let s:blue     = [ 67, '#D4BFFF'] " 
let s:orange   = [166, '#dbbc7f'] " ORANGE - way right (trailing...) #DBA40E
let s:outerfg  = [ 16, '#8d96a1'] "NORMAL text - way left
let s:outerfgi = [ 16, '#ffffff'] " 
